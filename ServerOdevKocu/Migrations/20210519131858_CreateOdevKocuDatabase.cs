...
{
    public partial class CreateOdevKocuDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyPlans_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudyPlans_AspNetUsers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ControlStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HomeworkTasks_Homeworks_HomeworkId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeworkTaskId = table.Column<int>(type: "int", nullable: true),
                    Extra = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyPlanTasks_HomeworkTasks_HomeworkTaskId",
                        column: x => x.HomeworkTaskId,
                        principalTable: "HomeworkTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudyPlanTasks_StudyPlans_StudyPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkTasks_HomeworkId",
                table: "HomeworkTasks",
                column: "HomeworkId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyPlans_TeacherId",
                table: "StudyPlans",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_StudyPlanTasks_HomeworkTaskId",
                table: "StudyPlanTasks",
                column: "HomeworkTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_StudyPlanTasks_StudyPlanId",
                table: "StudyPlanTasks",
                column: "StudyPlanId");
        }
